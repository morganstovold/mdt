...
<<<<<<< HEAD
        destructive: 'bg-destructive text-destructive-foreground shadow-sm hover:bg-destructive/90 text-red-200',
=======
        destructive: 'bg-destructive/40 text-red-200 hover:bg-destructive/60 hover:text-red-100 shadow-sm',
